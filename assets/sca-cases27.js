...
(function(){
  ...
  const c101 = {
    ...
    knowledge:{
      guideline:'NICE hyperprolactinaemia · Society for Endocrinology / Endocrine Society prolactin guidance',
      points:[
  ...
  const c103 = {
    ...
    knowledge:{
      guideline:'NICE NG28 / PH38 type 2 diabetes prevention · NHS Diabetes Prevention Programme · NICE NG238 CVD risk',
      points:[
  ...
  const c104 = {
    ...
    knowledge:{
      guideline:'NICE NG132 hyperparathyroidism · NICE hypercalcaemia · myeloma work-up where indicated',
      points:[
