...
(function(){
  ...
  const c141 = {
    ...
    knowledge:{
      guideline:'NICE pruritus (generalised) · NICE NG12 (haematological malignancy / lymphadenopathy) · systemic itch work-up',
      points:[
  ...
  const c142 = {
    ...
    knowledge:{
      guideline:'NICE shingles (herpes zoster) · herpes zoster ophthalmicus · antiviral window · post-herpetic neuralgia',
      points:[
  ...
  const c143 = {
    ...
    knowledge:{
      guideline:'NICE NG12 Suspected cancer (skin) · NICE SCC/BCC/actinic keratosis · non-melanoma skin cancer pathways',
      points:[
