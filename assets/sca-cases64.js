...
(function(){
  ...
  const c231 = {
    ...
    checkpoints:[
      ...
      { dom:'tasks', text:'Offers EVIDENCE-BASED treatment per NICE \u2014 CBT with EXPOSURE AND RESPONSE PREVENTION (ERP) as the cornerstone and/or an SSRI (often higher dose, longer to work in OCD) \u2014 using stepped care and referral to specialist/IAPT' },
