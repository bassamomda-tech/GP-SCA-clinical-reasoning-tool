...
(function(){
  ...
  const c46 = {
    ...
    knowledge:{
      guideline:'NICE jaundice / hepatitis · UKHSA viral hepatitis & notifiable disease guidance · BASHH testing · NICE NG12 (painless jaundice, older patients)',
      points:[
  ...
  const c47 = {
    ...
    knowledge:{
      guideline:'NICE haemochromatosis · BSG/EASL iron-overload guidance · genetic cascade-testing principles',
      points:[
