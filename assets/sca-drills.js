...
window.SCA_DRILLS = {
  ...
  nets: [
    ...
    { s:'Starting an SSRI in a 24M with moderate depression, some passive thoughts, no plan.',
      ...
      note:'SSRI initiation at 18\u201325 inclusive (or at any increased suicide risk, any age) has a specific, examinable net: the early-activation warning, same-day contact routes including out-of-hours, a SHORT review interval (1 week), and crisis numbers physically given — not recited.' },
