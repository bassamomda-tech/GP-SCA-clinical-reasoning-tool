...
(function(){
  ...
  function injectCss(){
    ...
    st.textContent =
      ...
      /* dark headers: the teal fails contrast on the near-black hero (1.42:1) */
      '.alg-header .cite-link,.alg-header a.cite-link{color:#f2ede2;text-decoration-color:rgba(242,237,226,.7);}' +
      '.alg-header .cite-link:hover{color:#fff;text-decoration-color:currentColor;}';
