...
(function(){
  ...
  const c157 = {
    ...
    knowledge:{
      guideline:'NICE hair loss / telogen effluvium · iron-deficiency and thyroid in diffuse alopecia · alopecia psychological impact',
      points:[
  ...
  const c158 = {
    ...
    knowledge:{
      guideline:'NICE hair loss (postpartum telogen effluvium) · NICE CG192 postnatal mental health · postpartum thyroiditis',
      points:[
  ...
  const c159 = {
    ...
    knowledge:{
      guideline:'NICE vitiligo · vitiligo associated autoimmunity · skin camouflage / psychological support',
      points:[
  ...
  const c160 = {
    ...
    knowledge:{
      guideline:'NICE NG12 Suspected cancer (lymphoma/haematological) · NICE night sweats · TB/HIV consideration',
      points:[
