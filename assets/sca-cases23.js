...
(function(){
  ...
  const c85 = {
    ...
    knowledge:{
      guideline:'BSR/BOA septic arthritis · NICE acute monoarthritis · NICE NG253 sepsis',
      points:[
        ...
        { h:'Don\u2019t rely on systemic features', t:'Fever and raised inflammatory markers support the diagnosis but their absence does NOT exclude it. Screen for sepsis (NG253), but act on the joint picture and risk factors regardless of how systemically well the patient seems.' },
  ...
  const c86 = {
    ...
    knowledge:{
      guideline:'BSR giant cell arteritis & PMR guidelines · NICE GCA / PMR',
      points:[
  ...
  const c87 = {
    ...
    knowledge:{
      guideline:'NICE NG219 gout · BSR gout guideline · NICE gout',
      points:[
