...
(function(){
  ...
  const c138 = {
    ...
    knowledge:{
      guideline:'NICE reactive arthritis · hot swollen joint / septic arthritis (BSR) · BASHH STI screening & partner notification',
      points:[
  ...
  const c139 = {
    ...
    knowledge:{
      guideline:'NICE carpal tunnel syndrome · median nerve compression · CTS associations',
      points:[
