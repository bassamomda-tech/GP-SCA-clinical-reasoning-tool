...
(function(){
  ...
  const c22 = {
    ...
    knowledge:{
      guideline:'NICE NG31 care of the dying adult · NICE palliative pain · PCF/hospice opioid titration',
      points:[
  ...
  const c23 = {
    ...
    knowledge:{
      guideline:'NICE NG31 care of dying adults · ReSPECT process · NICE palliative care (last days)',
      points:[
