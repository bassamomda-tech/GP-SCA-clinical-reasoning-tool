...
(function(){
  ...
  const c145 = {
    ...
    knowledge:{
      guideline:'NICE NG12 Suspected cancer (laryngeal / head and neck) · NICE hoarseness · head-and-neck cancer pathways',
      points:[
  ...
  const c146 = {
    ...
    knowledge:{
      guideline:'NICE nasal obstruction / epistaxis · NICE NG12 (head and neck) · nasopharyngeal carcinoma red flags',
      points:[
  ...
  const c148 = {
    ...
    knowledge:{
      guideline:'NICE globus pharyngeus · NICE NG12 (head and neck red flags) · laryngopharyngeal reflux',
      points:[
