...
(function(){
  ...
  const c13 = {
    ...
    knowledge:{
      guideline:'BASHH urethritis/chlamydia/gonorrhoea guidance · NICE UTI in men',
      points:[
  ...
  const c14 = {
    ...
    knowledge:{
      guideline:'NICE UTI (lower, men) & delirium · SIGN/PHE diagnosis of UTI in older people',
      points:[
  ...
  const c15 = {
    ...
    knowledge:{
      guideline:'NICE NG12 (May 2025) — bladder & renal cancer recognition · NICE haematuria',
      points:[
