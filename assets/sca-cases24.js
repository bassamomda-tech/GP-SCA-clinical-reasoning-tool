...
(function(){
  ...
  const c90 = {
    ...
    knowledge:{
      guideline:'NICE red eye · College of Optondonists / RCOphth acute red eye · contact-lens keratitis guidance',
      points:[
  ...
  const c91 = {
    ...
    knowledge:{
      guideline:'NICE hearing loss (sudden) · ENT UK / BAO-HNS sudden sensorineural hearing loss guidance',
      points:[
  ...
  const c92 = {
    ...
    knowledge:{
      guideline:'NICE NG12 Suspected cancer (May 2025) — oral/head & neck · NICE oral cancer · betel/areca-nut carcinogenicity',
      points:[
