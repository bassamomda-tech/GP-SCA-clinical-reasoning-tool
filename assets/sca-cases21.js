...
(function(){
  ...
  const c77 = {
    ...
    knowledge:{
      guideline:'NICE NG249 falls · NICE NG56 multimorbidity / STOPP-START · NOGG/FRAX bone health · BGS frailty',
      points:[
  ...
  const c79 = {
    ...
    knowledge:{
      guideline:'NICE guidance — Paget\u2019s disease of bone · Royal Osteoporosis Society Paget\u2019s guidance',
      points:[
