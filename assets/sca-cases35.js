...
(function(){
  ...
  const c133 = {
    ...
    knowledge:{
      guideline:'NICE NG49 NAFLD · FIB-4 / ELF fibrosis assessment · NICE NG238 CVD risk · metabolic syndrome',
      points:[
  ...
  const c134 = {
    ...
    knowledge:{
      guideline:'BSR giant cell arteritis · NICE GCA / PMR / raised ESR-CRP · sight-threatening emergency pathways',
      points:[
  ...
  const c135 = {
    ...
    knowledge:{
      guideline:'NICE macrocytosis / anaemia · NICE alcohol-use disorders · bereavement & low mood',
      points:[
