...
(function(){
  ...
  const c97 = {
    ...
    knowledge:{
      guideline:'UK Kidney Association / Renal Association hyperkalaemia guideline · NICE hyperkalaemia · NICE NG203 CKD',
      points:[
  ...
  const c98 = {
    ...
    knowledge:{
      guideline:'NICE NG203 chronic kidney disease · NICE CKD · KDIGO risk classification (eGFR + ACR)',
      points:[
  ...
  const c99 = {
    ...
    knowledge:{
      guideline:'NICE hyponatraemia · Society for Endocrinology / European hyponatraemia guidance · STOPP-START (older adults)',
      points:[
