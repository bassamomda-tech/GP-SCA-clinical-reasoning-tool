...
(function(){
  ...
  const c93 = {
    ...
    knowledge:{
      ...
      points:[
        ...
        { h:'Management by severity', t:'Mild\u2013moderate: guided self-help / psychological therapy (perinatal NHS Talking Therapies), health-visitor support, social support. Moderate\u2013severe: psychological therapy and/or an antidepressant \u2014 sertraline is commonly used and compatible with breastfeeding \u2014 with informed discussion. Involve the partner and health visitor; consider the wider context (birth trauma, isolation).' },
  ...
  const c94 = {
    ...
    checkpoints:[
      ...
      { dom:'tasks', text:'Negotiates an evidence-based plan matched to severity: psychological therapy (referral to NHS Talking Therapies) and/or an SSRI for moderate depression with informed discussion, the fit note used appropriately as part of care, lifestyle/alcohol, activity and social reconnection, and follow-up' },
    ...
    knowledge:{
      ...
      points:[
        ...
        { h:'Evidence-based management', t:'For moderate depression: offer psychological therapy (NHS Talking Therapies) and/or an antidepressant (e.g. an SSRI) with informed discussion of benefits, side effects and the early-weeks risk period. Use the fit note appropriately, encourage behavioural activation, exercise and social reconnection, and arrange follow-up.' },
  ...
  Object.assign(window.SCA_EXTRAS, {
    ...
    'postnatal-depression': {
      ...
      timeMap: [
        ...
        { t:'9–12', h:'Plan + safety-net',    d:'Perinatal/NHS Talking Therapies, talking therapy, breastfeeding-safe sertraline if moderate+, health visitor, partner; crisis routes if thoughts of harm escalate; close follow-up.' }
      ],
      wordPics: {
