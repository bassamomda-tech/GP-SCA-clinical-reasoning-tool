  ...
  const c173 = {
    ...
    script:{
      ...
      facts:[
        ...
        { topic:'What genuinely works \u2014 honest evidence', text:'The two evidence-based treatments are TOPICAL MINOXIDIL (5% solution/foam) and ORAL FINASTERIDE (5\u03b1-reductase inhibitor, 1 mg). Honest framing: they slow loss and can partially regrow, work best earlier, take 3\u20136 months to show effect, and the benefit is maintained only while continuing \u2014 stop and the gain is lost over months. Finasteride is more effective but carries sexual side-effects in a minority (reduced libido/erectile/ejaculatory issues, which may persist after stopping) plus depression and suicidal ideation (MHRA 2026: ask about any history of depression first; stop and seek advice if mood changes; patient alert card) and is a prescription with counselling; it is not licensed for women and is teratogenic (handling caution). Minoxidil can cause local irritation and initial shedding. (Note: in the NHS these are generally private/cosmetic; be clear about availability.)' },
    ...
    checkpoints:[
      ...
      { dom:'tasks', text:'Gives an HONEST evidence summary of what works \u2014 topical minoxidil and oral finasteride \u2014 with realistic effect size, 3\u20136-month time course, the maintenance/ongoing-use caveat, and finasteride\u2019s sexual side-effects (may persist after stopping), mood/suicidal-ideation warning and teratogenicity/handling' },
    ...
    worked:[
      ...
      { lbl:'What actually works', txt:'"Two things have real evidence: a solution called minoxidil you put on the scalp, and a tablet called finasteride. They slow the loss and can thicken things up a bit \u2014 but they take three to six months, work best started early, and only keep working while you use them. The tablet\u2019s a bit more effective but can affect sex drive or function in a small number of men \u2014 occasionally even after stopping \u2014 and has been linked to low mood, so we\u2019d talk that through."' },
    ...
    knowledge:{
      ...
      points:[
        ...
        { h:'What works', t:'Topical minoxidil (5%) and oral finasteride (1 mg): slow loss, partial regrowth, 3\u20136 months to effect, benefit only while continued. Finasteride more effective but sexual side-effects in a minority (may persist after stopping), depression/suicidal ideation (MHRA 2026 \u2014 ask about mood history; stop and seek advice if mood changes), teratogenic, not for women.' },
