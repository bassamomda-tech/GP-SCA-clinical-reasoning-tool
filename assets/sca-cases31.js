...
(function(){
  ...
  const c117 = {
    ...
    knowledge:{
      guideline:'NICE guidance — Bell\u2019s palsy · stroke (FAST) · Ramsay Hunt; facial nerve anatomy (UMN vs LMN)',
      points:[
  ...
  const c119 = {
    ...
    knowledge:{
      guideline:'NICE optic neuritis / MS · NICE NG220 multiple sclerosis · neurology/ophthalmology pathways',
      points:[
