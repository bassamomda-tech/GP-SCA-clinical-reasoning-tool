...
(function(){
  ...
  const c61 = {
    ...
    knowledge:{
      guideline:'NICE NG12 Suspected cancer (testicular) · NICE scrotal lumps · EAU testicular cancer',
      points:[
  ...
  const c62 = {
    ...
    knowledge:{
      guideline:'NICE scrotal pain · BAUS/EAU testicular torsion · paediatric surgical emergency pathways',
      points:[
  ...
  const c63 = {
    ...
    knowledge:{
      guideline:'UK NSC / NHS Prostate Cancer Risk Management Programme (informed choice) · NICE NG12 (symptomatic) · NICE PSA',
      points:[
  ...
  const c64 = {
    ...
    knowledge:{
      guideline:'NICE erectile dysfunction · NICE NG238 CVD risk · BSSM ED guidance · NICE NG23/OSA',
      points:[
