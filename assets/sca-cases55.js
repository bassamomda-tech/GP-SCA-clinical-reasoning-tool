...
(function(){
  ...
  const c194 = {
    ...
    checkpoints:[
      ...
      { dom:'tasks', text:'Manages anxiety/panic positively \u2014 breathing/relaxation techniques (not paper-bag), psychoeducation, CBT/psychological therapy (self-referral/IAPT), addressing triggers/stressors and lifestyle (caffeine/sleep), SSRIs if significant \u2014 and screens mood/severity' },
    ...
    knowledge:{
      ...
      points:[
        ...
        { h:'Positive management', t:'Controlled/diaphragmatic breathing (not paper-bag), psychoeducation, CBT/psychological therapy (self-referral/IAPT), address triggers/stressors and lifestyle (caffeine, sleep), SSRI for significant panic disorder; screen mood.' },
  ...
  Object.assign(window.SCA_EXTRAS, {
    ...
    'breathless-anxiety': {
      ...
      timeMap: [
        ...
        { t:'9\u201312', h:'Positive management', d:'Breathing techniques, CBT/IAPT, triggers/caffeine/sleep, SSRI if significant; safety-net atypical features.' }
      ],
      wordPics: {
