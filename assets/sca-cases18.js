...
(function(){
  ...
  const c65 = {
    ...
    knowledge:{
      guideline:'NICE NG143 fever in under-5s (traffic-light) · NICE NG254 sepsis · NICE NG12 (paediatric red flags) · meningococcal guidance',
      points:[
  ...
  const c66 = {
    ...
    knowledge:{
      guideline:'NICE limping child · BSCOS/ paediatric orthopaedic guidance · Kocher criteria · NICE NG12 (paediatric malignancy)',
      points:[
  ...
  const c67 = {
    ...
    knowledge:{
      guideline:'NICE/BTS-SIGN asthma & wheeze in children · NICE NG143 context · NICE preschool wheeze · smoking cessation',
      points:[
  ...
  const c68 = {
    ...
    knowledge:{
      guideline:'NICE febrile seizure · NICE NG143 fever in under-5s · epilepsy/seizure first-aid guidance',
      points:[
