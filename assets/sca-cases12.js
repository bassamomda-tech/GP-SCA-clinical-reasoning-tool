...
(function(){
  ...
  const c42 = {
    ...
    knowledge:{
      guideline:'NICE NG28 type 2 diabetes · NICE NG238 CVD risk · DVLA Assessing fitness to drive (diabetes) · DiRECT (remission)',
      points:[
        ...
        { h:'Glycaemic management + remission', t:'Lifestyle is genuine first-line; drug treatment now starts as DUAL therapy \u2014 MR metformin + an SGLT2 inhibitor for the majority, even with no comorbidity (NG28, Feb 2026), then branching by phenotype (ASCVD \u2192 triple with s/c semaglutide up to 1mg; HF/CKD \u2192 SGLT2i priority; obesity/early-onset \u2192 earlier GLP-1 RA or tirzepatide; frailty \u2192 caution with SGLT2i). In recent-onset T2DM with excess weight, structured weight loss can achieve remission (DiRECT) — offer it as a goal, not "tablets forever".' },
  ...
  const c43 = {
    ...
    knowledge:{
      guideline:'NICE NG19 diabetic foot problems · NICE cellulitis · NICE NG253 sepsis · Carers Act (assessment/respite)',
      points:[
        ...
        { h:'Screen for sepsis and systemic upset', t:'Fever, rigors, malaise, deranged glucose, tachycardia → assess for sepsis (NG253) and escalate to 999/A&E. Infection commonly drives hyperglycaemia; high sugars with a hot foot raise concern.' },
