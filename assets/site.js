/* ============================================
   ...
   ============================================ */
/* Accessibility toolkit — loaded once per page. Clinical pages get it via
   provenance.js; every page that loads site.js (hubs, tools, marketing) gets
   it from here. Both sides guard on window.__rgpA11yDone so it never double-loads.
   NOTE: do not reuse the name __rgpA11y here — the skip-link block near the end
   of this file already owns it, and a11y.js reading that flag as its own guard
   is exactly what silently disabled the toolkit on every site.js page. */
(function(){
  if(window.__rgpA11yDone || document.querySelector('script[src*="assets/a11y.js"]')) return;
  var el = document.querySelector('script[src*="assets/site.js"], link[href*="assets/site.css"]');
  var u = el ? (el.getAttribute('src') || el.getAttribute('href') || '') : '';
  var m = u.match(/^(.*?)assets\//);
  var s = document.createElement('script');
  s.src = (m ? m[1] : '') + 'assets/a11y.js?v=2';
...
window.RGP_CASES = [
  {
    ...
    items: [
      { id:"hypertension",     title:"Hypertension",                  setting:"New diagnosis · Adult",  status:"full",  path:"cases/hypertension.html", guideline:"NICE NG136" },
      { id:"afib",             title:"Atrial Fibrillation",           setting:"New diagnosis · Adult",  status:"full",  path:"cases/atrial-fibrillation.html", guideline:"NICE NG196" },
      { id:"heart-failure",    title:"Heart Failure",                 setting:"New presentation",       status:"full",  path:"cases/heart-failure.html", guideline:"NICE NG106" },
  ...
  },
  {
    ...
    items: [
      { id:"t2dm-new",         title:"Type 2 Diabetes",               setting:"New diagnosis",          status:"full",  path:"cases/type-2-diabetes.html", guideline:"NICE NG28" },
  ...
  },
  {
    ...
    items: [
      { id:"abdo-pain",        title:"Abdominal Pain",                setting:"Symptom framework",      status:"full",  path:"cases/abdominal-pain.html", guideline:"NICE · NG12" },
  ...
  },
  {
    ...
    items: [
      ...
      { id:"enuresis",         title:"Nocturnal Enuresis",            setting:"Paediatric",             status:"full",  path:"cases/enuresis.html", guideline:"NICE CG111" },
  ...
  },
  {
    ...
    items: [
      ...
      { id:"vertigo",          title:"Vertigo",                       setting:"BPPV / vestibular",      status:"full",  path:"cases/vertigo.html", guideline:"NICE · Bárány 2022" },
      ...
      { id:"migraine",         title:"Migraine",                      setting:"Diagnosis & management", status:"full",  path:"cases/migraine.html", guideline:"NICE CG150" },
      { id:"headache",         title:"Headache",                      setting:"SNOOP4 · primary vs secondary", status:"full", path:"cases/headache.html", guideline:"NICE / NG12 / ICHD-3" },
      { id:"tremor",           title:"Tremor",                        setting:"Essential / Parkinsonian / drug-induced", status:"full", path:"cases/tremor.html", guideline:"NICE · NG71" },
  ...
  },
  {
    ...
    items: [
      { id:"anaemia",          title:"Anaemia",                       setting:"Micro / macro / normo",  status:"full",  path:"cases/anaemia.html", guideline:"NICE / BSH 2021" },
      { id:"abnormal-lfts",    title:"Abnormal LFTs",                 setting:"Incidental derangement", status:"full",  path:"cases/abnormal-lfts.html", guideline:"BSG 2017 / NICE" },
      { id:"hyponatraemia",    title:"Hyponatraemia",                 setting:"Na 125–134",             status:"full",  path:"cases/hyponatraemia.html", guideline:"NICE · ES 2014" },
      { id:"hypercalcaemia",   title:"Hypercalcaemia",                setting:"Ca >2.6 mmol/L",         status:"full",  path:"cases/hypercalcaemia.html", guideline:"NICE · ES 2016" },
    ]
  },
  {
    group: "Acute & MSK",
    items: [
      ...
      { id:"neck-pain",        title:"Neck Pain",                     setting:"Mechanical · radiculopathy · myelopathy", status:"full", path:"cases/neck-pain.html", guideline:"NICE / NG12" },
      { id:"hip-pain",         title:"Hip Pain",                      setting:"OA · GTPS · referred · ± red flags", status:"full", path:"cases/hip-pain.html", guideline:"NICE / NG226" },
      { id:"shoulder-pain",    title:"Shoulder Pain",                 setting:"Rotator cuff · frozen shoulder · ± red flags", status:"full", path:"cases/shoulder-pain.html", guideline:"NICE / NG12" },
      { id:"sciatica",         title:"Sciatica",                      setting:"Radiculopathy · ± red flags", status:"full", path:"cases/sciatica.html", guideline:"NICE NG59" },
      { id:"axial-spa",        title:"Axial Spondyloarthritis",       setting:"Inflammatory back pain", status:"full",  path:"cases/axial-spa.html", guideline:"NICE NG65" },
      { id:"gout",            title:"Gout",                          setting:"Acute & chronic · SCA",  status:"full",  path:"cases/gout.html", guideline:"NICE / BSR 2017" },
      ...
      { id:"neuropathic-pain", title:"Neuropathic Pain",              setting:"Diagnosis & first-line meds", status:"full", path:"cases/neuropathic-pain.html", guideline:"NICE CG173" },
    ]
  },
  {
    group: "Ophthalmology",
    items: [
      { id:"red-eye",          title:"Red Eye",                       setting:"Acute presentation · SCA", status:"full",  path:"cases/red-eye.html", guideline:"College of Optometrists CMGs" },
      { id:"dry-eye",          title:"Dry Eye Disease",               setting:"Diagnosis & lubricants", status:"full", path:"cases/dry-eye.html", guideline:"NICE / TFOS DEWS II" },
  ...
  },
  {
    ...
    items: [
      { id:"hiv",              title:"HIV — primary-care role",       setting:"Testing & primary care", status:"full",  path:"cases/hiv.html", guideline:"BHIVA 2020 / NICE" },
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      { id:"urticaria",        title:"Urticaria & Angioedema",        setting:"Acute / chronic · angioedema", status:"full", path:"cases/urticaria.html", guideline:"NICE / BSACI" },
      { id:"allergic-rhinitis", title:"Allergic Rhinitis",           setting:"INCS · united airways",  status:"full",  path:"cases/allergic-rhinitis.html", guideline:"NICE / BSACI" },
      { id:"eczema",           title:"Atopic Eczema",                 setting:"Emollients · steroid ladder · FTU", status:"full", path:"cases/eczema.html", guideline:"NICE NG190 / NICE" },
      ...
      { id:"fungal-infections", title:"Fungal Infections",            setting:"Tinea · candida · confirm before orals", status:"full", path:"cases/fungal-infections.html", guideline:"PCDS · GM antimicrobial guidelines" },
      { id:"pruritus",         title:"Itch (Pruritus)",               setting:"Rash vs no rash · systemic", status:"full", path:"cases/pruritus.html", guideline:"NICE / NG12" },
    ]
  },
  {
    group: "Oncology & 2WW",
  ...
  },
  {
    group: "Sexual Health",
    items: [
      { id:"vaginal-discharge", title:"Vaginal Discharge & STI Screen", setting:"BV · candida · STI · PID", status:"full", path:"cases/vaginal-discharge.html", guideline:"BASHH / NICE" },
      { id:"erectile-dysfunction", title:"Erectile Dysfunction",      setting:"CV sentinel · PDE5 inhibitor", status:"full", path:"cases/erectile-dysfunction.html", guideline:"NICE / BSSM" },
    ]
  },
  {
  ...
  let html = `
    ...
    <div class="sb-scroll" id="sbScroll">
      ...
      <a class="sb-item ${activeId==='__algorithms'?'active':''}" href="${PRE}tools/algorithms.html" data-search="algorithms pathways flowchart decision tree quick visual print printable diagnosis triage">
        ...
        <span class="sb-i-text"><b>Diagnostic Algorithms</b><div class="sb-i-meta">200+ visual pathways · diagnose &amp; triage</div></span>
      </a>
...
const RGP_NAV_SECTIONS = [
  ...
  {id:'__updates',  label:'Updates',           icon:'📰', path:'pages/updates.html',      meta:'Weekly NICE · UKHSA · guideline changes'},
  ...
  {id:'__articles', label:'Articles',           icon:'📚', path:'pages/articles.html',     meta:'A–Z primary-care topic notes · 400+ conditions'},
];

/* Tools withheld from every public listing — the mega-menu, the Clinic Toolkit
   list, the command palette and the Tools count all derive from RGP_TOOLS, so
   filtering here is the single point of control.

   Consult Scribe: withheld pending its information-governance and consent
   requirements (recording a live consultation engages UK GDPR, patient consent
   and record-keeping duties that are not yet in place). The page still exists
   and remains reachable by direct URL for paid members, and it is noindex — to
   withdraw it completely, gate it for all tiers in bronzeReason().
   Remove the id from this array to restore it to the menus. */
const RGP_HIDDEN_TOOLS = ['__tools-scribe'];
const RGP_TOOLS_ALL = RGP_TOOLS.slice();
RGP_TOOLS = RGP_TOOLS.filter(t => RGP_HIDDEN_TOOLS.indexOf(t.id) === -1);
...
const RGP_MGMT_SPECIALTIES = [
  {label:'Cardiovascular & Renal',          icon:'🫀', n:15},
  {label:'Endocrine & Metabolic',           icon:'🦋', n:18},
  {label:'Respiratory',                     icon:'🫁', n:5},
  {label:'Mental Health',                   icon:'🧩', n:13},
  {label:'Neurology',                       icon:'🧠', n:17},
  {label:'Gastroenterology',                icon:'🫃', n:15},
...
function renderTopNav(activeId){
  ...
  // Headline totals are shown in rounded "200+" form so the nav never states a
  // figure that drifts as pages are added; per-specialty tiles keep exact counts.
  const algDisp='200+', mgmtDisp='200+', caseDisp='100+', artDisp='400+';
  ...
  const casesMega = `
    <a class="rgp-mm-tool ${activeId==='__cases'?'is-active':''}" href="${PRE}cases.html">
      ...
      <span><b>All of Casebook</b><small>Browse all ${caseDisp} cases</small></span>
    </a>
  ...
  const algMega = `
    <a class="rgp-mm-tool ${activeId==='__algorithms'?'is-active':''}" href="${PRE}tools/algorithms.html">
      ...
      <span><b>All Pathways</b><small>Browse all ${algDisp} pathways</small></span>
    </a>
  ...
  const mgmtMega = `
    <a class="rgp-mm-tool ${activeId==='__tools-management'?'is-active':''}" href="${PRE}tools/management.html">
      <span class="rgp-mm-tool-ic">💠</span>
      <span><b>All Protocols</b><small>Browse all ${mgmtDisp} cards</small></span>
    </a>
  ...
  const coreMega = mmHead('Pathways \u00b7 diagnose &amp; triage', algDisp) + algMega
                 + mmHead('Protocols \u00b7 manage', mgmtDisp) + mgmtMega;
  const refTotal = totalCases + ARTICLES_N;
  const refArticles = `
    <a class="rgp-mm-tool ${activeId==='__articles'?'is-active':''}" href="${PRE}pages/articles.html">
      <span class="rgp-mm-tool-ic">\uD83D\uDCDA</span>
      <span><b>A\u2013Z Articles</b><small>Primary-care topic notes \u00b7 ${artDisp} conditions</small></span>
    </a>`;
  const refAudios = `
  ...
  const refMega = mmHead('Casebook \u00b7 full walkthroughs', caseDisp) + casesMega
                + mmHead('Articles', artDisp) + refArticles
  ...
  const coreMenu = `
    ...
    <a class="rgp-mm-tool" href="${PRE}tools/algorithms.html">
      <span class="rgp-mm-tool-ic">🗺️</span><span><b>Pathways</b><small>${algDisp} pathways · diagnose &amp; triage</small></span>
    </a>
    <a class="rgp-mm-tool" href="${PRE}tools/management.html">
      <span class="rgp-mm-tool-ic">💠</span><span><b>Protocols</b><small>${mgmtDisp} protocols · manage the condition</small></span>
    </a>
  ...
  const refMenu = `
    ...
    <a class="rgp-mm-tool" href="${PRE}cases.html">
      <span class="rgp-mm-tool-ic">📋</span><span><b>Casebook</b><small>${caseDisp} full clinical walkthroughs</small></span>
    </a>
    <a class="rgp-mm-tool" href="${PRE}pages/articles.html">
      <span class="rgp-mm-tool-ic">📚</span><span><b>Articles</b><small>${artDisp} A–Z topic notes</small></span>
    </a>
  ...
  return `
    <div class="rgp-iface-bar">
      <div class="rgp-iface-inner">
        ...
        <div class="rgp-navend">
          <a class="rgp-nav-plans" href="${PRE}pages/pricing.html">Plans</a>
          <div class="rgp-auth">
    ...
    <div class="rgp-nav-row">
      ...
      <nav class="rgp-primary" aria-label="Primary">
        ...
        <a class="rgp-nav-btn rgp-nav-link ${activeId==='__ask'?'is-active':''}" data-navkey="ask" href="${PRE}pages/ask.html" title="Ask any clinical question in plain English — answered from the library, then NICE &amp; the BNF, with links to the matching pathway, protocol or case.">
          <span class="rgp-nav-sect-ic">💬</span>
          <span>Ask</span>
        </a>
...
const RGP_ALGORITHMS = [
  { mg:'hypertension', slug:'hypertension', label:"New presentation of high blood pressure", sys:'Cardiovascular', syn:"" },
  ...
  { mg:'hypercholesterolaemia', slug:'high-cholesterol', label:"High Cholesterol", sys:'Cardiovascular', syn:"hyperlipidaemia dyslipidaemia lipids qrisk" },
  { mg:'leg-cramps', slug:'leg-cramps', label:"Leg Cramps", sys:'Cardiovascular', syn:"" },
  { mg:'raynauds', slug:'raynauds', label:"Raynaud's Phenomenon", sys:'Cardiovascular', syn:"" },
  ...
  { mg:'diverticular-disease', slug:'diverticulitis', label:"Diverticulitis", sys:'Gastroenterology', syn:"" },
  { mg:'crohns-disease', slug:'crohns-flare', label:"Crohn's Disease", sys:'Gastroenterology', syn:"crohns disease ibd" },
  { mg:'ulcerative-colitis', slug:'uc-flare', label:"Ulcerative Colitis", sys:'Gastroenterology', syn:"ulcerative colitis ibd" },
  ...
  { mg:'fatty-liver', slug:'fatty-liver', label:"Fatty Liver Disease", sys:'Gastroenterology', syn:"" },
  ...
  { mg:'aki', slug:'aki', label:"Acute Kidney Injury", sys:'Renal & Urology', syn:"acute kidney injury" },
  { mg:'ckd', slug:'ckd', label:"Chronic Kidney Disease", sys:'Renal & Urology', syn:"chronic kidney disease renal" },
  { slug:'haematuria', label:"Haematuria", sys:'Renal & Urology', syn:"" },
  { slug:'renal-colic', label:"Renal Colic", sys:'Renal & Urology', syn:"" },
  { mg:'male-luts', slug:'luts-men', label:"LUTS in Men", sys:'Renal & Urology', syn:"lower urinary tract symptoms prostate bph" },
  { mg:'female-urinary-incontinence', slug:'urinary-incontinence-female', label:"Urinary Incontinence", sys:'Renal & Urology', syn:"stress urge incontinence bladder" },
  ...
  { mg:'undescended-testis', slug:'undescended-testis', label:"Undescended Testis", sys:'Renal & Urology', syn:"" },
  { mg:'erectile-dysfunction', slug:'erectile-dysfunction', label:"Erectile Dysfunction", sys:'Renal & Urology', syn:"ed impotence" },
  { mg:'premature-ejaculation', slug:'premature-ejaculation', label:"Premature Ejaculation", sys:'Renal & Urology', syn:"" },
  ...
  { mg:'type-2-diabetes', slug:'t2dm', label:"Type 2 Diabetes Mellitus", sys:'Endocrine', syn:"type 2 diabetes diabetes hba1c" },
  { mg:'hyperthyroidism', slug:'hyperthyroidism', label:"Hyperthyroidism", sys:'Endocrine', syn:"" },
  { mg:'hypothyroidism', slug:'hypothyroidism', label:"Hypothyroidism", sys:'Endocrine', syn:"" },
  ...
  { mg:'hyperhidrosis', slug:'hyperhidrosis', label:"Hyperhidrosis", sys:'Endocrine', syn:"" },
  { slug:'headache', label:"Headache", sys:'Neurology', syn:"" },
  { mg:'tia-stroke', slug:'tia', label:"Stroke & TIA", sys:'Neurology', syn:"transient ischaemic attack mini stroke secondary prevention clopidogrel" },
  ...
  { mg:'dysmenorrhoea', slug:'dysmenorrhoea', label:"Dysmenorrhoea", sys:'Women’s Health', syn:"" },
  { slug:'irregular-periods', label:"Irregular Periods", sys:'Women’s Health', syn:"" },
  { mg:'menorrhagia', slug:'menorrhagia', label:"Menorrhagia", sys:'Women’s Health', syn:"" },
  ...
  { mg:'contraception', slug:'contraception', label:"Contraception", sys:'Women’s Health', syn:"women requesting contraception pill coil implant larc emergency" },
  { mg:'hrt-prescribing', slug:'hrt-menopause', label:"Menopause & HRT", sys:'Women’s Health', syn:"hormone replacement therapy perimenopause hrt request suspected menopause vasomotor flushes" },
  { mg:'nausea-vomiting-pregnancy', slug:'nvp', label:"Nausea & Vomiting in Pregnancy", sys:'Women’s Health', syn:"nausea vomiting pregnancy morning sickness hyperemesis" },
  ...
  { mg:'iron-deficiency-anaemia', slug:'iron-deficiency', label:"Iron Deficiency", sys:'Haematology', syn:"" },
...
function injectPalette(){
  ...
  window.RGP_CASES.forEach(grp => {
    grp.items.forEach(it => {
      ...
      const href = isClickable ? (PRE + it.path) : (PRE + 'tools/clinic-guide.html#framework');
  ...
  RGP_ALGORITHMS.forEach(a => entries.push({
    type: a.mg ? 'management' : 'algorithm',
    group: (a.mg ? 'Protocols · ' : 'Algorithms · ') + a.sys,
    title: a.label,
    meta: a.sys + (a.mg ? ' protocol' : ' pathway'),
    href: PRE + (a.mg ? 'tools/management/' + a.mg : 'tools/algorithms/' + a.slug) + '.html',
    search: expandAbbr([a.label, a.sys, a.syn || '', a.mg ? 'protocol management guide' : 'algorithm pathway flowchart'].join(' ')),
  }));
...
(function(){
  ...
  // A signed-in FREE account may open: Articles, Resources,
  ...
  // else (Ask, Consult Scribe, Prescribing, CPD, other clinic tools, all SCA tools, the
  ...
  // Curated 5 sample cases. THIS LIST IS DUPLICATED in two other places and all
  // three MUST agree, or the page tells Google one thing and the gate does
  // another (a searcher lands on a lock screen, or an open page is marked
  // gated and never indexed):
  //   1. here — the runtime gate + the "Free" badges on cases.html
  //   2. the canonical/paywall SEO block at the foot of this file
  //   3. the same SEO block copied into assets/alg-nav.js (case pages that
  //      don't load site.js still need correct JSON-LD)
  // Chosen as the shop window: highest-volume presentations, one per section of
  // the library, all status:"full". Previously this was derived from catalogue
  // ORDER, so the free set was whatever sorted first rather than the best work.
  const FREE_CASES = new Set(['chest-pain.html','hypertension.html','type-2-diabetes.html','headache.html','anaemia.html']);
  ...
  function bronzeReason(){
    ...
    // Consult Scribe is NOT in this list: it is a paid feature, and it is also
    // withheld pending its legal/information-governance requirements (see
    // RGP_HIDDEN_TOOLS). Handled by its own branch below so the gate can say so.
    const OPEN = ['articles.html','resources.html','leaflets.html','consultation-spine.html','sca-guide.html','sca-group.html','clinic-guide.html','privacy.html','terms.html','disclaimer.html','pricing.html','content-safety.html','ai-safety.html','accessibility.html'];
    if (OPEN.indexOf(base) > -1) return null;
    if (/scribe\.html$/.test(base)) return 'scribe';
  ...
  // Pages withheld from ALL tiers, not merely unlisted. A feature held back on
  // legal / information-governance grounds must not be reachable by a paying
  // member with the URL — being absent from the menus is not a control.
  // The admin keeps access so it can still be worked on.
  const WITHHELD = ['scribe.html'];
  function isWithheld(){ return WITHHELD.indexOf((location.pathname.split('/').pop()||'')) > -1; }
  function allowed(){
    if (!window.RGPAuth) return true;
    if (RGPAuth.isAdmin && RGPAuth.isAdmin()) return true;
    if (isWithheld()) return false;
  ...
  function render(){
    ...
    if (!u && !isWithheld()){
      ...
      html = '<h2>This feature is on hold</h2>'+
        '<p><b>Consult Scribe is not currently available on any plan.</b> It is withheld while its information-governance and consent requirements are completed — recording a live consultation engages UK GDPR, patient consent and NHS record-keeping duties, and those need to be in place first. Nothing you have saved in it has been deleted.</p>'+
        '<div class="rgp-gate-btns"><a class="rgp-gate-btn pri" href="'+P+'tools/clinic-guide.html">Browse the clinic toolkit →</a>'+
        '<a class="rgp-gate-btn sec" href="'+P+'pages/ai-safety.html">How we handle AI and data</a></div>';
    } else {
      const t = RGPAuth.tier();
      const wrongArea = (t === 'silver' || t === 'gold');
      const reason = isWithheld() ? 'scribe' : ((t === 'bronze') ? bronzeReason() : null);
      const reasonMsg = {
        ...
        'scribe':'Consult Scribe is a paid feature and is currently being withheld while its information-governance and consent requirements are completed.',
      ...
      const body = wrongArea
          ...
          : (t==='bronze'
              ? ((reasonMsg[reason]||'This is a members feature.')+' Your free plan still includes articles, resources, patient leaflets, the consultation spine, and 5 sample cases &amp; pathways.')
              : 'Pick a plan to unlock the toolkit, or enter an access code if you\u2019ve been given one.');
      html = '<h2>'+head+'</h2>'+
        '<p>'+body+'</p>'+
        '<div class="rgp-gate-btns"><a class="rgp-gate-btn pri" href="'+P+'pages/pricing.html">See the plans →</a></div>'+
  ...
  // 'scribe' is deliberately absent: Consult Scribe is withheld from all tiers,
  // so it must never be offered as a metered free AI trial.
  const AI_TRIAL_LABELS = {
    'ask':'Ask the assistant', 'ask-quality':'Ask',
    'consultation-spine':'the Consultation Spine AI draft',
  ...
  const missionHtml = isHome ? `
    <section class="rgp-footer-mission" id="about" data-screen-label="Mission and vision">
      <div class="rgp-footer-mission-inner">
        ...
        <div class="rgp-mv">
          ...
          <p>Every case mapped to NICE or named UK guidance, every tool surfacing the reasoning behind the action, every recommendation linked back to a clear, repeatable framework — so safe, high-quality care reaches every patient, and strong exam performance is simply a reflection of how the team already practises.</p>
        </div>
      </div>
    </section>
    ...
    <section class="rgp-footer-subs" id="subscriptions" data-screen-label="Subscriptions">
      <div class="rgp-footer-subs-inner">
        <div class="rgp-subs-band">
          <div class="rgp-subs-band-txt">
            <span class="eyebrow">Plans</span>
            <h2>Start free, then from £10 a month</h2>
            <p>Five pathways, five protocols and five cases are open to everyone — no card, no sign-up. Silver is the clinic toolkit, Gold the SCA suite, Platinum both, and yearly billing saves up to 25%.</p>
          </div>
          <div class="rgp-subs-band-act">
            <a class="rgp-foot-btn is-primary" href="${PRE}pages/pricing.html">Compare the plans →</a>
            <a class="rgp-foot-btn is-ghost" href="${PRE}tools/management/hypertension.html">Open a free protocol</a>
          </div>
        </div>
        <a class="rgp-refer-strip" href="${PRE}pages/pricing.html#refer">
          <span class="rgp-refer-tag">Give a month, get a month</span>
          <span class="rgp-refer-txt">Refer a colleague and you <b>both</b> get 30 days of full Platinum access — free, up to 3 months for you, and it stacks on top of any plan.</span>
          <span class="rgp-refer-cta">Get your code →</span>
        </a>
      </div>
    </section>
` : '';
  footer.innerHTML = `${missionHtml}
    <style id="rgp-foot-css">
      .rgp-footer{ position:relative; margin-top:56px; padding:0; border:0; background:radial-gradient(120% 140% at 12% 0%, #0f5a55 0%, #0c4a47 46%, #093834 100%); overflow:hidden; }
      ...
      .rgp-foot-shell{ position:relative; max-width:1040px; margin:0 auto; padding:0 24px; }

      /* Pre-footer CTA band */
      .rgp-foot-cta{ position:relative; margin:30px 0 4px; padding:22px 28px; border-radius:16px; display:flex; align-items:center; justify-content:space-between; gap:24px; flex-wrap:wrap; background:linear-gradient(120deg, rgba(255,255,255,.07), rgba(255,255,255,.02)); border:1px solid rgba(255,255,255,.12); box-shadow:0 18px 44px rgba(0,0,0,.22); }
      ...
      /* Brand beside a self-sizing group rail. The old layout used four rigid
         tracks (1.7fr 1fr 1fr 1.3fr) that stayed 4-across until 880px, so each
         link column was ~157px, every label wrapped to two lines, and all four
         columns equalised to the tallest — a 12-link list — giving a 652px row.
         Four balanced groups in an auto-fit rail removes the equalisation. */
      /* Home-page plans band. This section used to repeat all four plan cards,
         which was 1020px — half the home footer — and duplicated
         pages/pricing.html exactly. The #subscriptions anchor is kept because
         older links and the paywall gate still point at it.
         NOTE: .rgp-footer-subs sits on a CREAM background (var(--bg)), not the
         dark footer, so this band uses ink text — the footer's white-on-teal
         styles are invisible here. */
      .rgp-subs-band{ display:flex; align-items:center; justify-content:space-between; gap:28px; flex-wrap:wrap; padding:4px 0; }
      .rgp-subs-band-txt{ flex:1 1 380px; min-width:0; }
      .rgp-subs-band-txt h2{ font-family:'Source Serif 4',Georgia,serif; font-size:24px; font-weight:600; color:var(--ink,#1c1917); margin:6px 0 8px; letter-spacing:-.01em; }
      .rgp-subs-band-txt p{ font-size:13.5px; line-height:1.6; color:var(--ink-2,#44403c); margin:0; max-width:62ch; }
      .rgp-subs-band-act{ display:flex; gap:10px; flex-wrap:wrap; flex:none; }
      .rgp-subs-band-act .rgp-foot-btn{ font-size:14px; font-weight:600; padding:11px 20px; border-radius:10px; text-decoration:none; display:inline-flex; align-items:center; justify-content:center; white-space:nowrap; }
      .rgp-subs-band-act .is-primary{ background:var(--teal,#0c4a47); color:#fff; border:1px solid var(--teal,#0c4a47); }
      .rgp-subs-band-act .is-primary:hover{ background:var(--teal-2,#0e5c58); border-color:var(--teal-2,#0e5c58); transform:none; }
      .rgp-subs-band-act .is-ghost{ background:#fff; color:var(--teal,#0c4a47); border:1px solid var(--line-2,#d8cfba); }
      .rgp-subs-band-act .is-ghost:hover{ background:#fff; border-color:var(--teal-3,#136a65); transform:none; }
      @media (max-width:620px){ .rgp-subs-band-act{ width:100%; } .rgp-subs-band-act .rgp-foot-btn{ flex:1; } }
      /* Referral strip — the marketing hook under the plans band. Sits on the
         cream section, so it uses ink text and a rust accent, not footer white. */
      .rgp-refer-strip{ display:flex; align-items:center; gap:16px; flex-wrap:wrap; margin:16px 0 4px; padding:14px 18px; border-radius:12px; text-decoration:none; background:#fff; border:1px solid var(--line,#e7e0d1); border-left:4px solid var(--rust,#b54c2b); transition:border-color .15s, box-shadow .15s; }
      .rgp-refer-strip:hover{ border-color:var(--rust,#b54c2b); box-shadow:0 2px 0 var(--rust,#b54c2b); }
      .rgp-refer-tag{ flex:none; font-size:11px; font-weight:800; letter-spacing:.09em; text-transform:uppercase; color:#fff; background:var(--rust,#b54c2b); padding:6px 11px; border-radius:99px; white-space:nowrap; }
      .rgp-refer-txt{ flex:1 1 320px; min-width:0; font-size:14px; line-height:1.5; color:var(--ink-2,#44403c); }
      .rgp-refer-txt b{ color:var(--ink,#1c1917); }
      .rgp-refer-cta{ flex:none; font-size:14px; font-weight:700; color:var(--rust,#b54c2b); white-space:nowrap; }
      .rgp-refer-strip:hover .rgp-refer-cta{ text-decoration:underline; text-underline-offset:3px; }
      @media (max-width:620px){ .rgp-refer-strip{ padding:14px; gap:10px; } .rgp-refer-cta{ flex-basis:100%; } }
      .rgp-footer-cols{ display:grid; grid-template-columns:minmax(230px,1fr) minmax(0,2.1fr); gap:32px; max-width:1040px; margin:0 auto; padding:26px 24px 4px; box-sizing:border-box; }
      .rgp-foot-groups{ display:grid; grid-template-columns:repeat(auto-fit,minmax(118px,1fr)); gap:16px; align-content:start; }
      .rgp-footer-cols .rgp-foot-brand{ padding-right:30px; border-right:1px solid rgba(255,255,255,.1); }
      ...
      .rgp-foot-about{ font-size:12.5px; line-height:1.55; color:rgba(231,242,240,.74); margin:12px 0 12px; max-width:340px; }
      .rgp-foot-microtag{ display:inline-flex; align-items:center; gap:7px; font-size:12px; font-weight:600; color:#fff; padding:5px 12px; border-radius:99px; white-space:nowrap; background:rgba(255,255,255,.07); border:1px solid rgba(255,255,255,.13); }
      .rgp-foot-microtag::before{ content:""; width:7px; height:7px; border-radius:50%; background:var(--mustard,#caa23f); }
      .rgp-footer-cols h5{ font-size:11px; font-weight:700; letter-spacing:.13em; text-transform:uppercase; color:#fff; margin:0; display:flex; align-items:center; gap:8px; }
      .rgp-footer-cols h5::before{ content:""; width:14px; height:2px; border-radius:2px; background:var(--rust,#b54c2b); flex:none; }
      /* Collapsible groups. Open on desktop, closed under 720px where vertical
         space is scarce; the marker only appears where it actually toggles. */
      .rgp-foot-col > summary{ list-style:none; cursor:default; display:flex; align-items:center; justify-content:space-between; gap:10px; margin:0 0 10px; }
      .rgp-foot-col > summary::-webkit-details-marker{ display:none; }
      .rgp-foot-col > summary::after{ content:""; }
      .rgp-footer-cols .rgp-foot-col ul{ list-style:none; margin:0; padding:0; display:flex; flex-direction:column; gap:6px; }
      .rgp-footer-cols .rgp-foot-col a{ font-size:13px; color:rgba(231,242,240,.78); text-decoration:none; display:inline-flex; align-items:baseline; gap:6px; line-height:1.4; transition:color .15s; }
      .rgp-footer-cols .rgp-foot-col a::before{ content:'›'; font-size:14px; color:rgba(255,255,255,.3); transition:color .15s; }
      .rgp-footer-cols .rgp-foot-col a[target]::before{ content:'↗'; font-size:12px; }
      .rgp-footer-cols .rgp-foot-col a:hover{ color:#fff; }
      .rgp-footer-cols .rgp-foot-col a:hover::before{ color:var(--mustard,#caa23f); }
      .rgp-foot-contact{ display:flex; flex-wrap:wrap; gap:8px; margin-top:14px; padding-top:12px; border-top:1px solid rgba(255,255,255,.12); }
      /* Compact icon chips. The stacked icon + two-line label made the brand
         column 421px — taller than the whole link rail — so it, not the links,
         was setting the footer height. The names live in the legal row already. */
      .rgp-foot-contact-link{ display:inline-flex; align-items:center; gap:8px; text-decoration:none; padding:6px 11px 6px 7px; border-radius:99px; background:rgba(255,255,255,.06); border:1px solid rgba(255,255,255,.12); transition:background .15s,border-color .15s; }
      .rgp-foot-contact-link:hover{ background:rgba(255,255,255,.14); border-color:rgba(255,255,255,.26); }
      .rgp-foot-ci{ width:22px;height:22px;border-radius:50%;flex:none;display:flex;align-items:center;justify-content:center;background:transparent;color:#fff;border:0; }
      .rgp-foot-ci svg{ width:15px; height:15px; }
      .rgp-foot-contact-link:hover .rgp-foot-ci{ background:transparent; transform:none; }
      .rgp-foot-ct{ display:block; line-height:1.2; }
      .rgp-foot-ct small{ display:none; }
      .rgp-foot-ct b{ font-size:12.5px; font-weight:600; color:rgba(255,255,255,.9); transition:color .15s; white-space:nowrap; }
      ...
      .rgp-foot-legal{ position:relative; margin-top:18px; border-top:1px solid rgba(255,255,255,.1); background:rgba(0,0,0,.16); }
      .rgp-foot-legal-inner{ max-width:1040px; margin:0 auto; padding:18px 24px 22px; text-align:center; }
      .rgp-foot-legal-copy{ font-size:12.5px; font-weight:600; color:rgba(255,255,255,.86); }
      .rgp-foot-legal-disc{ font-size:11.5px; line-height:1.6; color:rgba(231,242,240,.62); max-width:820px; margin:8px auto 0; }
      .rgp-foot-legal-company{ font-size:11.5px; line-height:1.55; color:rgba(231,242,240,.62); max-width:820px; margin:6px auto 0; }
      ...
      .rgp-foot-legal-links{ display:flex; gap:6px 18px; justify-content:center; flex-wrap:wrap; margin-top:12px; }
      ...
      @media (max-width:880px){
        .rgp-foot-cta{ padding:22px 22px; }
        .rgp-footer-cols{ grid-template-columns:1fr; gap:22px; padding:22px 24px 4px; }
        .rgp-footer-cols .rgp-foot-brand{ padding-right:0; border-right:0; border-bottom:1px solid rgba(255,255,255,.1); padding-bottom:16px; }
      }
      /* Under 720px the groups become real accordions: closed by default, with a
         chevron, so the footer is a short stack of headings instead of 21 links. */
      @media (max-width:720px){
        .rgp-foot-groups{ grid-template-columns:1fr; gap:0; }
        .rgp-foot-col{ border-bottom:1px solid rgba(255,255,255,.1); }
        .rgp-foot-col > summary{ cursor:pointer; margin:0; padding:12px 2px; min-height:44px; box-sizing:border-box; }
        .rgp-foot-col > summary::after{ content:""; width:8px; height:8px; border-right:2px solid rgba(255,255,255,.5); border-bottom:2px solid rgba(255,255,255,.5); transform:rotate(45deg) translateY(-2px); transition:transform .18s; flex:none; }
        .rgp-foot-col[open] > summary::after{ transform:rotate(-135deg) translateY(-1px); }
        .rgp-foot-col > summary:focus-visible{ outline:2px solid var(--mustard,#caa23f); outline-offset:2px; border-radius:6px; }
        .rgp-footer-cols .rgp-foot-col ul{ padding:2px 0 14px; gap:11px; }
        .rgp-footer-cols .rgp-foot-col a{ min-height:26px; align-items:center; }
      }
      @media (max-width:520px){ .rgp-footer-cols{ padding:20px 20px 4px; } .rgp-foot-cta-actions{ width:100%; } .rgp-foot-btn{ flex:1; justify-content:center; } }
    </style>
    ...
    <div class="rgp-footer-cols">
      <div class="rgp-foot-brand">
        ...
        <p class="rgp-foot-about">Clinical reasoning for UK GP trainees, GPs and SCA candidates.</p>
        <div class="rgp-foot-microtag">Anchored to NICE</div>
      ...
      <div class="rgp-foot-groups">
      <details class="rgp-foot-col" open>
        <summary><h5>Clinical</h5></summary>
        <ul>
          <li><a href="${PRE}tools/clinic-guide.html#framework">The 7-step framework</a></li>
      ...
      <details class="rgp-foot-col" open>
        <summary><h5>Account</h5></summary>
        <ul>
          <li><a href="${PRE}pages/pricing.html">Plans and pricing</a></li>
      ...
      <details class="rgp-foot-col" open>
        <summary><h5>Trust &amp; legal</h5></summary>
        <ul>
          <li><a href="${PRE}pages/content-safety.html">How we keep content safe</a></li>
          <li><a href="${PRE}pages/ai-safety.html">AI safety and data</a></li>
          <li><a href="${PRE}pages/accessibility.html">Accessibility</a></li>
  ...
  // The `open` attribute is HTML state, not CSS, so a media query alone cannot
  // collapse the groups on small screens. Sync it to the breakpoint, but stop
  // as soon as the user toggles one themselves so we never fight their choice.
  //
  // User intent is detected by COMPARING AGAINST THE EXPECTED STATE rather than
  // by setting a flag around the write: `toggle` fires asynchronously, so a flag
  // cleared in the same tick is always gone by the time the handler reads it,
  // which made every programmatic collapse look like a user action and latched
  // the groups shut on any resize back to desktop.
  (function(){
    const groups = footer.querySelectorAll('.rgp-foot-col');
    if (!groups.length) return;
    const mq = window.matchMedia('(max-width:720px)');
    const expected = () => !mq.matches;
    let userTouched = false;
    const sync = () => { if (!userTouched) groups.forEach(d => { d.open = expected(); }); };
    groups.forEach(d => d.addEventListener('toggle', () => {
      if (d.open !== expected()) userTouched = true;
    }));
    sync();
...
(function(){
  ...
  var cl = document.createElement('script'); cl.src = base + 'cite-links.js?v=2'; cl.defer = true;
  document.head.appendChild(cl);
})();

/* ---- Accessibility: skip-to-content link + visible keyboard focus (July 2026 a11y audit) ---- */
(function(){
  if (window.__rgpSkipLink) return; window.__rgpSkipLink = 1;
  function init(){
...
(function(){
  ...
  // Keep in step with FREE_CASES / FREE_ALGS in the paywall block above.
  var FREE_CASES = ['chest-pain.html','hypertension.html','type-2-diabetes.html','headache.html','anaemia.html'];
