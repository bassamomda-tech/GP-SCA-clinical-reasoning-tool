    ...
    <div class="rgp-iface-bar">
      <div class="rgp-iface-inner">
        ...
        <div class="rgp-mode rgp-iface" role="tablist" aria-label="Switch interface">
          ...
          <button type="button" class="rgp-iface-install" onclick="window.RGPInstall&&window.RGPInstall()" style="font:inherit;font-size:11.5px;font-weight:700;color:var(--teal);background:none;border:none;cursor:pointer;padding:0;white-space:nowrap;">📲 Install app</button>
        </div>
        <div class="rgp-auth">
