...
(function(){
  ...
  const c32 = {
    ...
    knowledge:{
      guideline:'NICE CG95 / NG185 stable chest pain & angina · NICE angina · RACPC pathways',
      points:[
  ...
  const c33 = {
    ...
    knowledge:{
      ...
      points:[
        ...
        { h:'The stroke maths', t:'CHA\u2082DS\u2082-VASc = 3 (65\u201374, female, HTN) → anticoagulation recommended (NG196: offer if \u22652 \u2014 the SAME threshold in women as in men; consider if 1 in men; note sex adds no indication alone). Annualised stroke risk ~3\u20134%, compounding; AF strokes are larger and more disabling than average. DOAC reduces risk ~64%.' },
  ...
  const c34 = {
    ...
    knowledge:{
      guideline:'NICE NG106 chronic heart failure · ESC HF guidelines (quadruple therapy) · NICE HF',
      points:[
