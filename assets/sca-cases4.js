...
(function(){
  ...
  const c17 = {
    ...
    checkpoints:[
      ...
      { dom:'tasks', text:'Completes the NG12 myeloma panel now: serum protein electrophoresis + serum free light chains alongside the FBC, calcium and ESR (urine Bence-Jones only if free light chains are unavailable) — NG12 (2025) sends these together, not in stages — plus repeat bone profile, renal monitoring' },
    ...
    worked:[
      ...
      { lbl:'The 48-hour promise',    txt:'"Fast means this: one more set of blood tests that look for the actual fingerprint of it — done within forty-eight hours, not weeks. If the fingerprint\u2019s there, you\u2019re in front of a blood specialist on the urgent pathway. If it isn\u2019t, we\u2019ve lost nothing but two days."' },
    ...
    knowledge:{
      ...
      points:[
        ...
        { h:'Investigate — complete the panel', t:'NICE NG12 (2025): FBC, calcium, ESR/plasma viscosity, serum protein electrophoresis AND serum free light chains are one panel sent together (urine Bence-Jones only if free light chains are unavailable) — his FBC, calcium and ESR are back, so send the electrophoresis and light chains now; repeat bone profile and U&E; FBC film. X-rays can wait for haematology — the bloods cannot.' },
  ...
  const c18 = {
    ...
    knowledge:{
      guideline:'NICE hypercalcaemia · NG12 context · local oncology recurrence pathways',
      points:[
  ...
  Object.assign(window.SCA_EXTRAS, {
    ...
    'back-pain-myeloma': {
      ...
      timeMap: [
        ...
        { t:'6–10', h:'The 48-hour plan',      d:'Electrophoresis + light chains sent now to complete the NG12 panel, repeat bone profile, NSAID stopped and replaced today, hydration. The garage cue answered; the Eileen script separated from his.' },
