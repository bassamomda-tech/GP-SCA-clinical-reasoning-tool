...
(function(){
  ...
  const c26 = {
    ...
    knowledge:{
      guideline:'NICE NG97 dementia (assessment) · NICE NG23 menopause · NICE memory problems',
      points:[
  ...
  const c27 = {
    ...
    knowledge:{
      guideline:'NICE NG97 (BPSD) · NICE NG249 falls · Alzheimer\u2019s Society / Admiral Nurse pathways · safeguarding (Care Act) proportionality',
      points:[
