...
(function(){
  ...
  const c109 = {
    ...
    knowledge:{
      guideline:'BASHH PID guideline · NICE PID · BASHH partner notification · ectopic exclusion',
      points:[
  ...
  const c111 = {
    ...
    knowledge:{
      guideline:'NICE PCOS · international PCOS guideline (Rotterdam) · pre-conception care',
      points:[
  ...
  const c112 = {
    ...
    knowledge:{
      guideline:'BASHH chlamydia guideline · BASHH partner notification · NICE chlamydia',
      points:[
