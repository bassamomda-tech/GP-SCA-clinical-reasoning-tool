...
- Rapid onset/virilisation/very high testosterone → exclude androgen tumour → urgent.`,
    sources: [
      { label:'Endocrine Society · Society for Endocrinology', url:'https://www.endocrinology.org' },
    ],
  },
...
- ANY fever during/within 1 yr of travel → urgent malaria test.`,
    sources: [
      { label:'UKHSA — Malaria prevention guidelines (2025)', url:'https://www.gov.uk' },
    ],
  },
...
- Exclude UTI/thyroid/molar if atypical.`,
    sources: [
      { label:'RCOG Green-top 69 (2024)', url:'https://www.rcog.org.uk/guidance/' },
...
- Atypical (trauma, hot joint, inflammatory, neuro) → reconsider diagnosis.`,
    sources: [
      { label:'JOSPT heel pain guideline (2023)', url:'https://www.jospt.org' },
    ],
  }
  );
})();
