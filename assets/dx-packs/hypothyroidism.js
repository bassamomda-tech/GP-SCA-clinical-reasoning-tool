/* ============================================
   ...
   Shared-id triage + differential. NICE NG145
   ============================================ */
(function () {
  const INPUTS = [
  ...
  if (window.RGPDiagnostic) RGPDiagnostic.register('hypothyroidism-dx', {
    ...
    diagnoses: [
      ...
      { id: 'myxoedema', name: 'Myxoedema coma', summary: 'Hypothermia + reduced consciousness + bradycardia', baseline: 1, category: 'cant-miss',
        ...
        guideUrl: 'https://www.nice.org.uk/guidance/ng145', guideLabel: 'NICE NG145', redFlagAction: '\u26A1 999 / emergency admission' }
    ],
    effects: {
