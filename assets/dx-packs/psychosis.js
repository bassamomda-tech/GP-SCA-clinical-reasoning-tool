/* ============================================
   ...
   Shared-id triage + differential. NICE CG178 · risk + organic exclusion.
   ============================================ */
(function () {
  const INPUTS = [
  ...
  if (window.RGPTriage) RGPTriage.register('psychosis-triage', {
    ...
    subtitle: 'Tick features. Surfaces acute risk, organic causes and postpartum psychosis (NICE CG178).',
    guideline: 'NICE CG178',
    inputs: INPUTS,
    ...
    rules: [
      ...
      },
      {
        ...
        source: 'NICE CG178', sourceUrl: 'https://www.nice.org.uk/guidance/cg178',
    ...
    sources: [
      { label: 'NICE CG178 — Psychosis & schizophrenia', url: 'https://www.nice.org.uk/guidance/cg178' },
  ...
  if (window.RGPDiagnostic) RGPDiagnostic.register('psychosis-dx', {
    ...
    diagnoses: [
      ...
      { id: 'organic', name: 'Organic / delirium', summary: 'Acute, fluctuating, confusion, fever, neuro signs', baseline: 1, category: 'cant-miss',
        ...
        guideUrl: '', redFlagAction: '\u26A1 Same-day medical' },
      { id: 'postpartum', name: 'Postpartum psychosis', summary: 'Onset within weeks of childbirth', baseline: 1, category: 'cant-miss',
        ...
        guideUrl: '', redFlagAction: '\u26A1 Same-day perinatal psychiatry' }
    ],
    effects: {
