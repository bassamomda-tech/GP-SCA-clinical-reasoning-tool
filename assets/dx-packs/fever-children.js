  ...
  if (window.RGPTriage) RGPTriage.register('fever-children-triage', {
    ...
    rules: [
      ...
      },
      {
        ...
        action: 'Urine sample (clean catch) for all unexplained fever; treat per NICE NG224.',
        source: 'NICE NG224',
        when: i => i.urinary,
      },
      {
  ...
  if (window.RGPDiagnostic) RGPDiagnostic.register('fever-children-dx', {
    ...
    diagnoses: [
      ...
      { id: 'uti', name: 'Urinary tract infection', summary: 'Unexplained fever / urinary symptoms', baseline: 4, category: 'common',
        keyExam: 'Abdominal/loin tenderness; urine sample.', nextIx: 'Clean-catch urine; treat per NICE NG224; image per criteria.',
