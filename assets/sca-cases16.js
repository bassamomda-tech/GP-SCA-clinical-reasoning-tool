...
(function(){
  ...
  const c57 = {
    ...
    knowledge:{
      guideline:'NICE NG12 Suspected cancer (May 2025) — endometrial · NICE NG88 heavy menstrual bleeding · NICE postmenopausal bleeding',
      points:[
  ...
  const c58 = {
    ...
    knowledge:{
      guideline:'NICE NG23 menopause · NICE NG12 (endometrial 2WW) · NICE HRT / unscheduled bleeding · BMS guidance',
      points:[
  ...
  const c59 = {
    ...
    knowledge:{
      guideline:'NICE NG88 heavy menstrual bleeding · NICE menorrhagia / fibroids · NICE NG12 (consider where red flags)',
      points:[
