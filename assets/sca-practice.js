...
(function(){
  ...
  function renderKnowledge(){
    ...
    const CATS = [
      { key:'clinical',     ic:'🩺', label:'Clinical', sub:'NICE & UK clinical guidance — in consultation order', cls:'cat-clinical', items:(k.points||[]), html: clinHtml },
    ...
    mount.innerHTML = `
      <div class="kn-wrap">
        ...
        <div class="kn-foot">Educational summary anchored to UK guidance — always verify against the live NICE and your local formulary.</div>
      </div>`;
