...
(function(){
  ...
  const c154 = {
    ...
    knowledge:{
      guideline:'NICE NG143 fever in under-5s (traffic light) · NICE NG254 sepsis · febrile young infant pathways',
      points:[
  ...
  const c156 = {
    ...
    knowledge:{
      guideline:'NICE conjunctivitis / neonatal conjunctivitis · ophthalmia neonatorum (notifiable) · BASHH (maternal STI)',
      points:[
