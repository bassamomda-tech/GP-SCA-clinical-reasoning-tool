...
(function(){
  ...
  const c53 = {
    ...
    knowledge:{
      guideline:'UKMEC 2025 \u00b7 NICE CG150 headaches \u00b7 CoSRH (FSRH) contraception guidance \u00b7 NICE migraine',
      points:[
  ...
  const c54 = {
    ...
    knowledge:{
      guideline:'NICE CG150 headaches \u00b7 SIGN/− subarachnoid haemorrhage guidance \u00b7 NICE headache (thunderclap)',
      points:[
  ...
  const c55 = {
    ...
    knowledge:{
      guideline:'NICE NG133 hypertension in pregnancy & pre-eclampsia \u00b7 RCOG \u00b7 NICE pre-eclampsia',
      points:[
  ...
  const c56 = {
    ...
    knowledge:{
      guideline:'NICE CG150 headaches \u00b7 IHS classification (primary headache associated with sexual activity) \u00b7 NICE headache',
      points:[
