...
(function(){
  ...
  const c213 = {
    ...
    worked:[
      ...
      { lbl:'The rugby conversation', txt:'"Now, the important one: glandular fever swells the spleen, and a knock \u2014 like in rugby \u2014 can rarely make it rupture, which is dangerous. So no heavy lifting or strenuous exercise for at least a month, and no contact sport for about eight weeks \u2014 longer if your spleen is still enlarged. I\u2019m sorry, but Saturday\u2019s match is out."' },
    ...
    knowledge:{
      guideline:'Glandular fever / EBV (NICE) \u00b7 monospot/serology timing \u00b7 amoxicillin rash \u00b7 splenic rupture & contact-sport advice (no NG12 link)',
      points:[
  ...
  const c214 = {
    ...
    script:{
      ...
      facts:[
        ...
        { topic:'CRB-65 (and CURB-65)', text:'CRB-65 scores one point each for: CONFUSION (new), Respiratory rate \u226530/min, low Blood pressure (systolic <90 or diastolic \u226460), and age \u226565. Higher scores indicate higher mortality risk and favour hospital assessment (NICE NG250, with clinical judgement: 0 \u2014 usually home; 1 \u2014 primary care with safety-netting or other community options; \u22652 \u2014 consider hospital referral; sepsis \u2014 admit). In hospital CURB-65 adds Urea. He has new CONFUSION and is \u226565 \u2014 already concerning.' },
    ...
    knowledge:{
      ...
      points:[
        ...
        { h:'CRB-65', t:'1 point each: new Confusion, RR \u226530, low BP (SBP <90/DBP \u226460), age \u226565. 0 usually home; 1 primary care + safety-net or community options; \u22652 consider hospital referral (NICE NG250). CURB-65 adds Urea in hospital.' },
  ...
  Object.assign(window.SCA_EXTRAS, {
    ...
    'glandular-fever': {
      ...
      timeMap: [
        ...
        { t:'6\u20139',  h:'Spleen/sport rule', d:'Splenic risk \u2192 no heavy lifting \u22651 month (Bartlett, Injury 2016), no contact sport ~8 weeks (NHS patient information) (no rugby Saturday); LUQ/shoulder-tip pain = emergency.' },
      ...
      avoid: [
        ...
        { dont:'"Rest up and you should be fine for the match Saturday."', instead:'"No heavy lifting for at least a month and no contact sport for about eight weeks \u2014 the spleen can rupture; Saturday\u2019s out."', why:'Clearing contact sport early risks splenic rupture.' },
