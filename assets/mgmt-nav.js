...
(function(){
  function build(){
    ...
    if (printBtn) {
      /* Prefer the paginated <doc-page> copy (<slug>-print.html) — plain
         window.print() on the live page yields unpaginated, shadow-heavy
         output with the browser's own date/URL chrome. Fall back to
         window.print() only where no print copy has been generated. */
