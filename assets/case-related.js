...
(function(){
  ...
  const TOOLS = {
    ...
    medchooser: { icon:'💊', label:'Medication Chooser', path:'tools/medication-chooser.html', meta:'NICE · BNF' },
  ...
  function render(){
    ...
    const html = `
      <section class="case-related" data-screen-label="Connect">
        ...
        <div class="cr-foot">
          <a class="cr-foot-link" href="${PRE}tools/clinic-guide.html#framework">↑ 7-step framework</a>
