...
(function(){
  ...
  const c105 = {
    ...
    knowledge:{
      guideline:'NICE NG158 venous thromboembolic diseases · two-level Wells score · NICE DVT',
      points:[
  ...
  const c106 = {
    ...
    knowledge:{
      guideline:'Vascular Society / NICE PAD (CG147) \u2014 acute limb ischaemia · NICE peripheral arterial disease',
      points:[
  ...
  const c107 = {
    ...
    knowledge:{
      guideline:'NICE NG156 abdominal aortic aneurysm · NHS AAA screening programme · NICE AAA',
      points:[
