...
(function(){
  ...
  const c121 = {
    ...
    knowledge:{
      guideline:'NICE NG20 coeliac disease · NICE iron-deficiency anaemia / GI investigation · NICE IBS (diagnosis of exclusion)',
      points:[
  ...
  const c122 = {
    ...
    knowledge:{
      guideline:'NICE NG12 Suspected cancer (ovarian) · NICE CG122 ovarian cancer · NICE ovarian cancer',
      points:[
  ...
  const c123 = {
    ...
    knowledge:{
      guideline:'NICE NG12 Suspected cancer (pancreatic/hepatobiliary) · NICE jaundice · cholangitis (emergency)',
      points:[
  ...
  const c124 = {
    ...
    knowledge:{
      guideline:'NICE CG188 gallstone disease · NICE cholecystitis/biliary colic · sepsis (NG253)',
      points:[
